...
\restrict cRkiuMf0FAKbsm5OC3vf6x7i5NfVsQ9xdHeCE1S4bUb4mV930t89DVEXhbTQ3BH
...
49	13	انضمام الطالب S إلى نشاط: string	62	\N	\N	\N	2026-03-11 20:10:38.406678+02	طالب	نشاط	13
50	13	انضمام الطالب S إلى نشاط: string	62	\N	\N	\N	2026-03-11 20:15:42.015368+02	طالب	نشاط	13
\.
...
SELECT pg_catalog.setval('public.event_docs_doc_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.events_event_id_seq', 63, true);
...
SELECT pg_catalog.setval('public.logs_log_id_seq', 50, true);
...
SELECT pg_catalog.setval('public.plans_plan_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.prtcps_id_seq', 11, true);
...
\unrestrict cRkiuMf0FAKbsm5OC3vf6x7i5NfVsQ9xdHeCE1S4bUb4mV930t89DVEXhbTQ3BH
